...
const warningText = isPaused
  ? 'The bridge is currently paused due to an attack occurred on July 2nd, resulting from stolen or misused private keys. [**<u>For more information, read the postmortem here.</u>**](https://dedaub.com/blog/poly-chain-hack-postmortem)'
  : ''
